...
const { sendToUser, sendToChannel } = require("./services/sseService");
...
app.use(
  cors({
    origin: ["http://localhost:5173", "http://localhost:5174",'https://iot-project-git-main-dgs420s-projects.vercel.app','https://iot-project-h7xc-git-main-dgs420s-projects.vercel.app'],
    credentials: true,
  })
);
...
mqttEventEmitter.on("mqttMessage", (data) => {
  ...
  sendToChannel("device-notifications", {
    type: "ACTIVITY_LOG",
    payload: {
      data,
    },
